...
def analyze_iwm_data():
    ...
    try:
        ...
        for hour, row in market_hours.iterrows():
            ...
            print(f"   {hour_display:5} | {row['Volume']:10,.0f} | ${row['High']:7.2f} | ${row['Low']:7.2f} | ${row['Close']:8.2f}")
        ...
        print(f"\n🎯 Analysis Complete!")
        print(f"💡 Tip: Run this script again to see how caching speeds up data retrieval!")
